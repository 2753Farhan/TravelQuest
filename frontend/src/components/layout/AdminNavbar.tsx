...
import { Bars3Icon, BellIcon, CheckIcon, XMarkIcon, ChartBarIcon, UserGroupIcon, CogIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
      ...
      <div className="container mx-auto px-4 lg:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            <AdminNavLink to="/admin/dashboard" text="Dashboard" icon={<ChartBarIcon className="h-5 w-5" />} />
            <AdminNavLink to="/admin/users" text="Users" icon={<UserGroupIcon className="h-5 w-5" />} />
            <AdminNavLink to="/admin/content" text="Content" icon={<ShieldCheckIcon className="h-5 w-5" />} />
            <AdminNavLink to="/admin/settings" text="Settings" icon={<CogIcon className="h-5 w-5" />} />
          </div>
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-3">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-1 w-40 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-200 hidden group-hover:block">
                    <Link
                      to="/"
...
const AdminNavLink = ({ to, text, icon }: { to: string; text: string; icon: React.ReactNode }) => (
  <Link 
    to={to} 
    className="px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all duration-200 font-medium relative group flex items-center space-x-2"
  >
