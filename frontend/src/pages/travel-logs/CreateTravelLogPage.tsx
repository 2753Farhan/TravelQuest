...
import { MapPin, Calendar, Eye, Plus, ArrowLeft, Globe, Lock, Users } from 'lucide-react'
...
export default function CreateTravelLogPage() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      const log = await createTravelLog({
        ...data,
        creatorId: user.id,
      })
      toast.success('Travel log created successfully!')
      navigate(`/travel-logs/${log.logId}`)
    } catch (error) {
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-white">Create New Travel Log</h1>
                    <p className="text-indigo-100 mt-1">Document your adventures and share your journey</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 pb-3 border-b border-gray-200">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Give your travel log a name and description</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 pb-3 border-b border-gray-200">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">When does your adventure begin and end?</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 pb-3 border-b border-gray-200">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Control who can see your travel log</p>
                      </div>
                    </div>
